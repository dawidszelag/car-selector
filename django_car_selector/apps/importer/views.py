...
from .tasks import add_cars_data_to_database, add_cars_parameters_data_to_database, set_info_object
...
def import_data(request):
    if request.method == 'POST':
        ...
        set_info_object(lenght=1, current=0, message='Reading file...', status=UploadDataInfo.Status.PROCESSING)
