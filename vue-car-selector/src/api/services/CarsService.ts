...
export class CarsService {
    ...
    public static getCars({
        ...
        highestSafetyRatings?: boolean,
        lowFuelEconomy?: boolean,
        ...
        raceTrack?: boolean,
        raceTrackPlus?: boolean,
        rapidCharging?: boolean,
        lightOffRoad?: boolean,
        heavyOffRoad?: boolean,
        tallDriver?: boolean,
        firstTimeDrive?: boolean,
        kmRangeGte?: number,
        kmRangeLte?: number,
        ...
        return __request(OpenAPI, {
            ...
            query: {
                ...
                'hev': hev,
                'phev': phev,
                'mhev_petrol': mhevPetrol,
                'mhev_diesel': mhevDiesel,
                'electric': electric,
                'two_doors': twoDoors,
                ...
                'highest_safety_ratings': highestSafetyRatings,
                'low_fuel_economy': lowFuelEconomy,
                ...
                'race_track_plus': raceTrackPlus,
                'rapid_charging': rapidCharging,
                'light_off_road': lightOffRoad,
                'heavy_off_road': heavyOffRoad,
                'tall_driver': tallDriver,
                'first_time_drive': firstTimeDrive,
